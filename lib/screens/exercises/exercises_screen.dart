...
class ExercisesScreen extends StatelessWidget {
  ...
  const ExercisesScreen({Key? key, required this.tipo, required this.nombreEj}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    
    List<EjercicioRecomendado> ejercicios = Exercises.getExercisesRecomendedType(tipo);
